      ...
      <div>
        ...
        <div className='row'>
          <div className='col s12 m12 center'>
            <h3 className='big' style={{color: '#26c5f0'}}> The PUG Team </h3>
          </div>
        </div>
          <div className='row'>
            ...
            <div className='col s12 m3'>
              ...
              <hr />
              <p className='center small' style={{fontSize: '12px'}}><span  className='big' style={{fontWeight: 'bolder', fontSize: '18px', color: '#ff7821'}}> Alex Romney </span> is a technology guru and sports entusiast. After being introduced to volleyball at a young age, his love for the
